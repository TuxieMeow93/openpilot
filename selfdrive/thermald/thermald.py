...
DAYS_NO_CONNECTIVITY_MAX = 550  # do not allow to engage after a week without internet
DAYS_NO_CONNECTIVITY_PROMPT = 530  # send an offroad prompt after 4 days with no internet
